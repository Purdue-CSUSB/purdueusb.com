...
let searchData = [{
    ...
    "category":     "campus",
    "date":         "March 4, 2020",
    "content":      "The process of the hiring UTAs has been standardized in the Computer Science Department to simplify application evaluation.  Typically, applications for the following semester are opened about a month before classes end.  More information can be found on the Department of Computer Science website.",
    "author":       "Noah Alderton",
}, {
    "index":        3,
    "title":        "How can I rent equipment?",
    "description":  "Borrow equipment to tinker with for free",
    "url":          "/wiki/rent-equipment",
    "category":     "campus",
    "date":         "March 4, 2020",
    "content":      "There are a few different opportunities to rent equipment for both classwork and personal use.  The Department of Computer Science allows CS/DS students to rent various equipment online.The following devices are available to rent for 1 week at a time:  SenseHat  Raspberry Pi 3  Particle Photon  Pebble Smartwatch  LittleBits  Myo  LeapMotion  Parrot Rolling Spider MiniDrone  Oculus Rift DK2  HoloLensAdditionally, Purdue Libraries has cameras, camcorders, tripods, and hard drives available to rent for 3 days.To learn more, see the Purdue Libraries Equipment page.",
    "author":       "Noah Alderton",
}, {
    "index":        4,
    "title":        "Transferring Files via SCP and FileZilla",
    "description":  "Copy files to and from Purdue's servers",
    "url":          "/wiki/file-transfer",
    "category":     "technical",
    "date":         "April 1, 2020",
    "content":      "IntroductionSometimes there comes a need where you need to transfer a files between your personal computer and one of Purdue’s servers (like data.cs.purdue.edu).  The tutorial will show you how to transfer files between your computer and a remote server (and vice versa) using SCP via command line and FileZilla.  These methods will work on Windows, Mac, and Linux.Solution 1: Command LineStep 1On Windows open “Windows PowerShell.” On Mac or Linux, open your respective Terminal.Step 2In order to transfer your files, we are going to use SCP. SCP works the same regardless of operating system. The SCP program takes the following parameters:scp &lt;source_directory&gt; &lt;destination_directory&gt;For our purposes of transferring homework from data, we are going to use the following command:scp &lt;purdue_username&gt;@data.cs.purdue.edu:&lt;homework_directory&gt; &lt;personal_machine_directory&gt;For example, if I wanted to transfer my hw2.c file to my current directory on my PC, I would run:scp nalderto@data.cs.purdue.edu:~/cs240/hw2/hw2.c .Step 3If everything ran properly, you should be able to access your homework on your personal machine. Keep in mind that this is a copy of your homework, so any changes you make on your personal machine will not be reflected on data and vice versa. If we want to transfer a file from our personal machine to data, we would need to run SCP again, flipping the source and destination directories.For example, if I wanted to transfer my hw2.c file from my personal machine to data, I would run:scp hw2.c nalderto@data.cs.purdue.edu:~/cs240/hw2/Solution 2: FileZillaStep 1If you are not comfortable with the command line, there are several graphical user interface programs that are available which provide the same functionality. In this tutorial we are covering FileZilla, as it is compatible with Windows, Mac, and Linux.You can download FileZilla here.Step 2Once you have finished installing FileZilla, open it up. On the top, there should be 4 input boxes. Put in the following information:  Host: sftp://data.cs.purdue.edu  Username: Purdue Username  Password: Purdue Career Account Password (same password used to SSH into data)  Port: 22Step 3Once the appropriate information is entered, click “Quickconnect”. A dialog might appear about trusting the connect. Go ahead and trust the connection.Step 4You should now be connected to data! Your data filesystem is on the right part of the screen, while your personal computer’s files are on the left. You can drag and drop the files between the machines as you wish!",
    "author":       "Noah Alderton",
}, {
    "index":        5,
